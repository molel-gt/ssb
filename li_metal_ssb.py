...
if __name__ == '__main__':
    ...
    I_tot_ = cycler.current_mode["direction"] * utils.get_c_rate_current(c_max, cycler.current_mode["c-rate"], vol_pos_am) #utils.get_c_rate_current(c_max, args.C_rate, vol_pos_am)
    l_res = "-"
    r_res = "+"
