...
if __name__ == '__main__':
    ...
    domain_coarse, ct_coarse, ft_coarse = io.gmshio.read_from_msh(output_meshfile, comm, partitioner=partitioner)[:3]
    tdim = domain_coarse.topology.dim
    fdim = tdim - 1
    k = tdim - 2
    domain_coarse.topology.create_entities(1)
    domain_coarse.topology.create_entities(fdim)
    domain_coarse.topology.create_connectivity(tdim, fdim)
    domain_coarse.topology.create_connectivity(tdim, tdim)
    domain_coarse.topology.create_connectivity(fdim, fdim)
