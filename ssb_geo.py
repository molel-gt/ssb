...
if __name__ == '__main__':
    ...
    parser.add_argument("--name_of_study", help="name_of_study", nargs='?', const=1, default="tertiary_current")
    ...
    parser.add_argument("--refine", help="optional refining", default=False, action=argparse.BooleanOptionalAction)
    parser.add_argument("--structured", help="optional whether structured mesh", default=False, action=argparse.BooleanOptionalAction)
    args = parser.parse_args()
    resolution = args.resolution
    Lx, Ly, Lz = [float(val) for val in args.dimensions.split("-")]
    LX = Lx/Lx
    LY = Ly/Lx
    LZ = Lz/Lx
    ...
    workdir = os.path.join(configs.get_configs()['LOCAL_PATHS']['data_dir'], name_of_study, dimensions, f"{resolution}")
    ...
    points_1 = [
    (args.particle_radius/Lx, 0, 0),
    (args.particle_radius/Lx, 0.25 * LY, 0),
    (args.particle_radius/Lx, 0.75 * LY, 0),
    (args.particle_radius/Lx, LY, 0)
    ]
    points_2 = [
    (2 * args.particle_radius/Lx, 0, 0),
    (2 * args.particle_radius/Lx, 0.25 * LY, 0),
    (2 * args.particle_radius/Lx, 0.75 * LY, 0),
    (2 * args.particle_radius/Lx, LY, 0)
    ]
    points_3 = [
    (0.5 * LX, 0, 0),
    (0.5 * LX, 0.25 * LY, 0),
    ...
    points_4 = [
    (LX - args.particle_radius/Lx, 0, 0),
    (LX - args.particle_radius/Lx, 0.25 * LY, 0),
    (LX - args.particle_radius/Lx, 0.75 * LY, 0),
    (LX - args.particle_radius/Lx, LY, 0)
    ]
    points_right = [
    (LX, 0, 0),
    (LX, 0.25 * LY, 0),
